...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/tmdb-proxy.js', 'TMDB Proxy', '@lampa', 'TMDB');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/tmdb-proxy.js";
					...
					onRender: function (item) {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/tmdb-proxy.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="TMDB"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/tmdb-proxy.js') {
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/weather.js', 'Погода', '@scabrum', 'Weather');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/weather.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/weather.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/weather.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/weather.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/cub_off.js', 'Cub Off', '@scabrum', 'Cub_off');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/cub_off.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/cub_off.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/cub_off.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/cub_off.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/interface.js', 'Стильный Интерфейс', '@lampa', 'Style_interface_fix');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/interface.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/interface.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/interface.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/interface.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/source.js', 'Дополнительные Источники', '@scabrum', 'New_source');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/source.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/source.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/source.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/source.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/start.js', 'Start', '@scabrum', 'Start');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/start.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/start.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/start.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/start.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/rus_movie.js', 'Русские Новинки', '@bylampa', 'rus_movie');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/rus_movie.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/rus_movie.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="rus_movie"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/rus_movie.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/in_quality.js', 'В Качестве', '@bylampa', 'in_qual');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/in_quality.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/in_quality.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="in_qual"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/in_quality.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	         ...
	         Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/snow.js', 'Снег', '@bylampa', 'snow');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/snow.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/snow.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="snow"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/snow.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/logo_title.js', 'Лого Вместо Названия', '@bylampa', 'logo_title');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/logo_title.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/logo_title.js')
						setTimeout(function() {
							$('div[data-name="Weather"]').append('<div class="settings-param__status one"></div>')
							if (myResult) {
								$('div[data-name="Weather"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/logo_title.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/logo_title.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/cardify.js', 'Cardify', '@lampa', 'cardify');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/cardify.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/cardify.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="cardify"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/cardify.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/backmenu.js', 'Меню Выход', '@bylampa', 'back_menu');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/backmenu.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/backmenu.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="back_menu"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/backmenu.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/themes.js', 'Мои Темы', '@bylampa', 'my_themes');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/themes.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/themes.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="my_themes"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/themes.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/inter_movie.js', 'Зарубежные Подборки', '@bylampa', 'inter_movie');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/inter_movie.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/inter_movie.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="inter_movie"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/inter_movie.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/rate_lampa.js', 'Рейтинг Lampa', '@AndreyURL54', 'rate_lampa');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/rate_lampa.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/rate_lampa.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="rate_lampa"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/rate_lampa.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/old_card_status.js', 'Статус На Старой Карточке', '@bylampa', 'old_cards_status');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/old_card_status.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/old_card_status.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="old_cards_status"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/old_card_status.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/seas_and_eps.js', 'Состояние Сериала', '@bylampa', 'eps_and_seas');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/seas_and_eps.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/seas_and_eps.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="eps_and_seas"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/seas_and_eps.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/anime.js', 'Аниме', '@bylampa', 'anime_tmdb');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/anime.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/anime.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="anime_tmdb"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/anime.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/my_bookmarks.js', 'Мои Закладки', '@bylampa', 'my_bookmarks');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/my_bookmarks.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/my_bookmarks.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="my_bookmarks"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/my_bookmarks.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/color_vote.js', 'Цветные Оценки', '@fovway', 'color_vote');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/color_vote.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/color_vote.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="color_vote"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/color_vote.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/lable_serial.js', 'Лейбл Сериала', '@bylampa', 'lable_tv');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/lable_serial.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/lable_serial.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="lable_tv"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/lable_serial.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Управление */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/dlna.js', 'DLNA', '@lampa', 'DLNA');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/dlna.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/dlna.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="DLNA"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/dlna.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/redirect.js', 'Смена Сервера', '@scabrum', 'Redirect');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/redirect.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/redirect.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/redirect.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/redirect.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	       ...
	       /* Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/timecode.js', 'Синхронизация Таймкодов', '@scabrum', 'Timecode');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/timecode.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/timecode.js')
						setTimeout(function() {
						...
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/timecode.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/timecode.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/account.js', 'Аккаунт', '@bylampa', 'acc_bylampa');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/account.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/account.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="acc_bylampa"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/account.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
                ...
                Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://surtr4.github.io/nonewdata/cub_sync.js', 'CUB Sync', '@levende', 'cub_sync');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/cub_sync.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/cub_sync.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="cub_sync"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/cub_sync.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Онлайн */
		...
		Lampa.SettingsApi.addParam({
					...
					field: {
                           		...
                           		onChange: function(value) {
					if (value == '1') {
						itemON('https://surtr4.github.io/nonewdata/cinema.js', 'Онлайн Cinema', '@cinema', 'online_cinema');
					}
					if (value == '2') {
						var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/cinema.js";
						deletePlugin(pluginToRemoveUrl);
					}
                },
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/cinema.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="online_cinema"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/cinema.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					field: {
                           		...
                           		onChange: function(value) {
					if (value == '1') {
						itemON('http://showwwy.com/m.js', 'Showy', '@showy', 'Showy');
					}
					if (value == '2') {
...
/* Торрент */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/jackett.js', 'Переключение Парсеров', '@AndreyURL54', 'Switch_Parser');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/jackett.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/jackett.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/jackett.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/jackett.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/tracks.js', 'Tracks', '@lampa', 'Tracks');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/tracks.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/tracks.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="Tracks"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/tracks.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/etor.js', 'Настройка Торрентов', '@lampa', 'Setting_torrents');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/etor.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/etor.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       $('div[data-name="Setting_torrents"]').append('<div class="settings-param__status one"></div>');
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/etor.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/freetorr.js', 'Free Torrserver', '@scabrum', 'free_torr');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/freetorr.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/freetorr.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/freetorr.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/freetorr.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Телеканалы */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://surtr4.github.io/nonewdata/tv.js', 'Hack TV', '@scabrum', 'Hack_TV');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://surtr4.github.io/nonewdata/tv.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://surtr4.github.io/nonewdata/tv.js')
						setTimeout(function() {
						...
						var myResult = checkPlugin('https://surtr4.github.io/nonewdata/tv.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://surtr4.github.io/nonewdata/tv.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
